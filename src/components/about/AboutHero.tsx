...
const headingLines = ["Designing spaces", "with purpose."];
    ...
    >
      ...
      <div className="relative flex flex-1 flex-col justify-end">
        <div className="container-site pb-16 pt-nav md:pb-24 lg:pb-28">
          ...
          >
            {headingLines.map((line) => (
              <div key={line} className="overflow-hidden leading-none">
                <motion.h1
                  id={line === headingLines[0] ? "about-hero-heading" : undefined}
          ...
          >
            An integrated practice bridging the gap between architectural vision and physical execution.
          </motion.p>
        </div>
      </div>
    </section>
